...
PROFESSION_SYSTEM = (
    ...
    "Use the star quality, remarks, and suggested fields only as gentle guidance, but YOU MUST EXPLICITLY LIST 6 TO 10 SPECIFIC CAREER OPTIONS OR JOB TITLES that best fit their numeric combinations. "
    ...
    "without predicting specific jobs, salaries, or guarantees (except for the 6 to 10 career suggestions). "
    ...
    "one bullet explicitly listing 6 to 10 tailored career options, "
    "and one or two bullets for practical, empowering guidance on how to use these tendencies well. "
    "Keep the total length of all bullets together around one hundred fifty to two hundred words. "
    + ANCHORS
)
